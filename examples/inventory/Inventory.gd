...
const ItemSlotClass = preload("res://examples/inventory/ItemSlot.gd");

const slotTexture = preload("res://examples/inventory/images/skil.png");
const itemImages = [
	preload("res://examples/inventory/images/Ac_Ring05.png"),
	preload("res://examples/inventory/images/A_Armor05.png"),
	preload("res://examples/inventory/images/A_Armour02.png"),
	preload("res://examples/inventory/images/A_Shoes03.png"),
	preload("res://examples/inventory/images/C_Elm03.png"),
	preload("res://examples/inventory/images/E_Wood02.png"),
	preload("res://examples/inventory/images/P_Red02.png"),
	preload("res://examples/inventory/images/W_Sword001.png")
];
